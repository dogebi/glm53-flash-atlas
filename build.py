...
const BENCH=[['GPQA Diamond','Reasoning',[88.1,93.4,94.1,92.9,92.4,89.9,90.9]],['Terminal-Bench 2.1','Agentic',[88.2,89.1,88.8,88.3,87.9,82.7,90.6]],['Terminal-Bench 3.0','Agentic',[28.3,43.3,34.4,17.7,11.8,7.6,30]],['Terminal-Bench 4.0','Agentic',[37.9,51.8,39.9,12.6,12.4,7,31.2]],['DeepSWE v1.1','Agentic',[66.9,74,73,67.5,62.7,54.4,74.2]],['ProgramBench','Agentic',[37,23,17.5,19,15.5,null,20.3]],['NL2Repo-Bench','Agentic',[58,75.3,56.8,58,61.5,54.2,64]],['CyberGym','Agentic',[null,84.5,80,84.5,83.3,76.7,88.1]],['SEC-Bench Pro','Agentic',[null,74.3,null,null,56.4,30.9,62.8]],['ExploitGym','Agentic',[22.1,33.7,null,15,5.4,1.8,15.3]],['HLE with tools','Agentic',[63.6,null,59.8,62.5,60,51.5,63.9]],['AutomationBench','Agentic',[48.8,50.3,45.8,46.7,43.2,37.7,54.8]],['Agent\'s Last Exam','Agentic',[28.5,28.6,26.7,27.6,25.7,25.2,31.8]],['Chartography with tools','Visual',[84,79.9,68.1,null,null,null,78.9]],['BabyVision with tools','Visual',[94.1,88.9,85.7,null,null,null,89.6]],['ZeroBench-main (Pass@5)','Visual',[52,53,41,null,null,null,49]]];
const BENCH_MODELS=['GLM-5.3 (this atlas)','Opus-5.0','GPT-5.6 Sol','K3','DS V4 Pro','DS V4 Flash','DS V4.1 Flash'];
/* This atlas measures bytes; the rows above are the comparison set published by the
   ...
   same options. the GLM-5.3 column is this atlas’s own model and is listed first. */
